...
public class CustomerResourceClient_Prob3{
	...
	public static void main(String[] args) {
		try {
			...
			getUrl = new URL("http://localhost:8090/rest/customers/2");
			connection = (HttpURLConnection) getUrl.openConnection();
			connection.setRequestMethod("GET");
			System.out.println("Content-Type: " + connection.getContentType());
			...
			getUrl = new URL("http://localhost:8090/rest/customers/4");
			connection = (HttpURLConnection) getUrl.openConnection();
			connection.setRequestMethod("GET");
			System.out.println("Content-Type: " + connection.getContentType());
			...
			URL deleteURL = new URL("http://localhost:8090/rest/customers/1");
			...
			getUrl = new URL("http://localhost:8090/rest/customers/2/2");
			connection = (HttpURLConnection) getUrl.openConnection();
			connection.setRequestMethod("GET");
			System.out.println("Content-Type: " + connection.getContentType());
